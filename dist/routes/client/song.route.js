...
router.patch("/like/:typeLike/:idSong", auth_middleware_1.requireAuth, controller.like);
router.patch("/favorite/:typeFavorite/:idSong", auth_middleware_1.requireAuth, controller.favorite);
